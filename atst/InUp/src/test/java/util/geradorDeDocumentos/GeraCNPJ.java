...
/** Classe para gerar numeracao de um CNPJ. */
...
/** Gerador de CNPJ para testes de cadastros novos de clientes*/
	public static void main(String[] args) {
		GeraCNPJ gerador = new GeraCNPJ();
		String cnpj = gerador.cnpj(false);
		System.out.printf(cnpj, gerador.isCNPJ(cnpj));
	}
	...
	/** Metodo para gerar um CNPJ.
	 * @return Retorna o numero gerado.
	 */
	public String comCnpj() {
		return cnpj(true);
	}
}
