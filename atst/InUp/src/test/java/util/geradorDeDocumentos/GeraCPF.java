...
/** Classe para gerar numeracao de um CPF. */
public class GeraCPF {
	...
	public String cpf(boolean semPontos) {
		int n = 9;
		int n1 = randomiza(n);
		int n2 = randomiza(n);
		int n3 = randomiza(n);
	...
	/** Gerador de CPF para testes de cadastros novos de clientes */
	...
	/** Metodo para gerar um CPF.
	 * @return Retorna o numero gerado.
	 */
	public String comCpf() {
		return cpf(true);
	}
}
